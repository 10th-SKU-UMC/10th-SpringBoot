...
public class ReviewConverter {
    ...
    public static ReviewResDTO.ReviewCursorItemDTO toReviewCursorItemDTO(Review review) {
        return ReviewResDTO.ReviewCursorItemDTO.builder()
                .reviewId(review.getId())
                .rating(review.getRating())
                .content(review.getContent())
    ...
    public static ReviewResDTO.ReviewCursorListDTO toReviewCursorListDTO(
            List<Review> reviews, String nextCursor, boolean hasNext) {
        List<ReviewResDTO.ReviewCursorItemDTO> items = reviews.stream()
                .map(ReviewConverter::toReviewCursorItemDTO)
                .collect(Collectors.toList());
        return ReviewResDTO.ReviewCursorListDTO.builder()
                .reviews(items)
