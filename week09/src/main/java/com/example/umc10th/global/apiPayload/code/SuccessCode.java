...
public enum SuccessCode implements BaseCode {
    ...
    LOGIN_SUCCESS(HttpStatus.OK, "MEMBER202", "로그인 성공입니다."),
    TOKEN_REFRESHED(HttpStatus.OK, "MEMBER203", "토큰 재발급 성공입니다."),
    MEMBER_WITHDRAWN(HttpStatus.OK, "MEMBER204", "회원 탈퇴 성공입니다."),
